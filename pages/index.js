        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4 md:p-6">
          <div className="grid grid-cols-3 gap-4 md:gap-6 text-center">
            ...
            <div>
              ...
              <div className="text-xs md:text-sm text-slate-400">Faster Analysis</div>
            </div>
            <div>
              <div className="text-2xl md:text-3xl font-bold text-white mb-1">24/7</div>
              <div className="text-xs md:text-sm text-slate-400">Always Available</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="order-first lg:order-last">
        {!submitted ? (
          <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8">
            ...
            <div className="space-y-2 md:space-y-3 mb-6 bg-slate-50 rounded-lg p-3 md:p-4">
            ...
            <div className="space-y-3 md:space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 md:py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
                />
              </div>
              ...
              <button
                ...
                className="w-full bg-slate-900 text-white py-3 md:py-4 rounded-lg font-semibold hover:bg-slate-800 transition-colors flex items-center justify-center space-x-2 text-sm md:text-base"
              >
